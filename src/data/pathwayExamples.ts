...
const step = (name: ICommandModel["name"], value: number): IExampleCommand => ({
  name,
  value,
});
...
export const pathwayExamples: readonly IPathwayExample[] = [
  ...
  },
  {
    ...
    command: buildExampleCommand(loop(5, step("fd", 220), step("tr", 144))),
  ...
  },
  {
    ...
    command: buildExampleCommand(
      loop(12, loop(4, step("fd", 120), step("tr", 90)), step("tr", 30)),
    ),
  ...
  },
  {
    ...
    command: buildExampleCommand(
      loop(45, loop(7, step("fd", 105), step("tr", 154)), step("tr", 10)),
    ),
